...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	// compute the rotation matrix expressing b in aÅfs coordinate frame
	for (int i = 0; i < 3; i++)
	{
		for (int j = 0; j < 3; j++)
		{
	...
	// compute subexpressions. add in an epsilon term to
	...
	//returning 1 means theyre in each other's collisions like two sports fans having a beef about each other's teams
	//returning 0 means that they're not touching, just like two siblings after their parents hear them fighting
